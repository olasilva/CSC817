...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-JLRWHA5W.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-JLRWHA5W.js")).default(client, args);
    case "add":
      return (await import("./add-T6Q4Z7IF.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-NKCIQNWD.js")).default(client, args);
    case "rm":
      return (await import("./rm-C54EEBUU.js")).default(client, args);
    case "update":
      return (await import("./update-67NV2T55.js")).default(client, args);
    default:
